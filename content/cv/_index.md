...
|--------------|------|------|-------|----------|
| ![Autism in Racing](air.png) | [Autism in Racing](https://www.autisminracing.com) | Freelance Marketing & Fundraising Officer<br><hr><br>Host (Ad Hoc) | Oct 2025 – Present<br><hr><br>Mar 2025 – Present | Hybrid<br>UK |
...
|-------------|--------|-------|----------|
| [<img src="/images/mmu.png" width="80"> Manchester Metropolitan University](https://www.mmu.ac.uk) | MSc Management (Strategy, Enterprise & Sustainability) | Jan 2024 – Jan 2025 | Manchester, UK |
...
{{< keywordList >}}
{{< keyword icon="seo" >}} SEO strategy & technical audits {{< /keyword >}}
{{< keyword icon="web" >}} Website & CMS management (Shopify, UX optimisation) {{< /keyword >}}
{{< keyword icon="bullhorn" >}} Paid media & digital campaigns (Google Ads, email, influencer marketing) {{< /keyword >}}
{{< keyword icon="chart-line" >}} Data analysis & reporting (Google Analytics, Power BI) {{< /keyword >}}
{{< keyword icon="file-text" >}} Content planning & copywriting {{< /keyword >}}
{{< keyword icon="users" >}} Stakeholder & team leadership {{< /keyword >}}
{{< /keywordList >}}
